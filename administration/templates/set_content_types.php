...
$saved_post_types = explode(',', get_option('MAFGUD_post_types'));
?>
<div class="admin-mafgud set_post_types clearfix">
  <div class="clearfix">
    <div id="label">
    ...
    <div id="settings">
      <select id="MAFGUD_post_types" name="MAFGUD_post_types" multiple>
        <?php
